...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ADHAM..":NameBot:")
...
elseif  UserID == 1488653639 then
var =  'مالك السورس'
elseif redis:sismember(ADHAM..':@Q_Y_4:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(ADHAM..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(ADHAM..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(ADHAM..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(ADHAM..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(ADHAM..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(ADHAM..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(ADHAM..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(ADHAM..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(ADHAM..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(ADHAM..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(ADHAM..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(ADHAM..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
function we_A(msg)
if msg.sender_user_id_ == A_ID then
return true 
else
return false
end 
...
function Alist(msg)
local list = redis:smembers(ADHAM..':@Q_Y_4:')
message = '♡ ** قائمه الـمـطـوريـن : \n\n`♡ مطور اساسي`**\n'..A_USER..' » ❪' ..A_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(ADHAM..'username:'..v)
local count = redis:scard(ADHAM..'mtwr_count'..v)
...
local monsha = redis:smembers(ADHAM..':@Q_Y_4:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n♡ قائمه المدراء :*\n\n'
local list = redis:smembers(ADHAM..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(ADHAM..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ADHAM..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ADHAM..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ADHAM..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ADHAM..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(ADHAM..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ADHAM..'gban_users')
...
local list = redis:smembers(ADHAM..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ADHAM..':Filter_Word:'..msg.chat_id_,word) then 
return  "♡ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(ADHAM..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(ADHAM..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(ADHAM..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(ADHAM..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(ADHAM..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(ADHAM..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(ADHAM..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local creators = redis:smembers(ADHAM..':@Q_Y_4:'..GroupS)
if #creators ~= 0 then
...
local list = redis:smembers(ADHAM..'group:ids')
message = '♡ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(ADHAM..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px ADHAM;}</style>
<body>
...
redis:del(
ADHAM..'group:add'..id_group,
ADHAM..'lock_link'..id_group, 
ADHAM..'lock_id'..id_group,
ADHAM..'lock_spam'..id_group, 
ADHAM..'lock_webpage'..id_group,
ADHAM..'lock_markdown'..id_group,
ADHAM..'lock_flood'..id_group,
ADHAM..'lock_bots'..id_group,
ADHAM..'mute_forward'..id_group,
ADHAM..'mute_contact'..id_group,
ADHAM..'mute_location'..id_group,
ADHAM..'mute_document'..id_group,
ADHAM..'mute_keyboard'..id_group,
ADHAM..'mute_game'..id_group,
ADHAM..'mute_inline'..id_group,
ADHAM..'lock_username'..id_group,
ADHAM..'num_msg_ADHAM'..id_group,
ADHAM..'replay'..id_group
)
redis:srem(ADHAM..'group:ids',id_group)
end
...
redis:hset(ADHAM..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(ADHAM..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if not msg.AUser and not service then return '♡ أنـت لـسـت الـمـطـور .' end
...
if redis:get(ADHAM..'group:add'..msg.chat_id_) then  return '♡ **المجموعة تم تفعيلها مُسبقاً . ' end

local UserChaneel = redis:get(ADHAM..":UserNameChaneel")
if UserChaneel and not msg.ABase then
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ADHAM..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(ADHAM..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
ADHAM..'group:add'..msg.chat_id_,true,
ADHAM..'lock_link'..msg.chat_id_,true, 
ADHAM..'lock_id'..msg.chat_id_,true,
ADHAM..'lock_spam'..msg.chat_id_,true,
ADHAM..'lock_webpage'..msg.chat_id_,true,
ADHAM..'lock_markdown'..msg.chat_id_,true,
ADHAM..'lock_flood'..msg.chat_id_,true,
ADHAM..'lock_bots'..msg.chat_id_,true,
ADHAM..'mute_forward'..msg.chat_id_,true,
ADHAM..'mute_contact'..msg.chat_id_,true,
ADHAM..'mute_location'..msg.chat_id_,true,
ADHAM..'mute_document'..msg.chat_id_,true,
ADHAM..'mute_keyboard'..msg.chat_id_,true,
ADHAM..'mute_game'..msg.chat_id_,true,
ADHAM..'mute_inline'..msg.chat_id_,true,
ADHAM..'lock_username'..msg.chat_id_,true,
ADHAM..'num_msg_ADHAM'..msg.chat_id_,5, 
ADHAM..'replay'..msg.chat_id_,true
)

redis:sadd(ADHAM..'group:ids',msg.chat_id_) 
redis:sadd(ADHAM..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(ADHAM..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(ADHAM..'linkGroup'..msg.chat_id_,Gp_Link)
if not we_A(msg) then
...
return send_msg(A_ID,'♡ ** تــــم تــفــعــيــل الـــبـــوت ...\n———————————————\n♡ معلومات المجموعه\n'
...
function modrem(msg)
if not msg.AUser then return '♡ ** أنـت لـسـت الـمـطـور .'end
if not redis:get(ADHAM..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID,'username',Resolv)
redis:sadd(ADHAM..':@Q_Y_4:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..':@Q_Y_4:'..ChatID,UserID)
...
if redis:sismember(ADHAM..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID,'username',Resolv)
redis:sadd(ADHAM..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(ADHAM..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(ADHAM..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(ADHAM..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(ADHAM..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..'whitelist:'..ChatID,UserID)
...
if redis:sismember(ADHAM..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..'owners:'..ChatID,UserID)
...
if redis:sismember(ADHAM..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(ADHAM..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(ADHAM..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(ADHAM..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ ** لا يمكنك حظر البابا ادهم\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مالك السورس\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مالك السورس\n") 
...
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(ADHAM..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(ADHAM..'banned:'..ChatID,UserID)
...
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم البابا ادهم\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم مالك السورس\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم مالك السورس\n") 
...
if redis:sismember(ADHAM..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(ADHAM..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(ADHAM..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء كتمه  \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مالك السورس\n")
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكن حظر البابا ادهم\n")  
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مالك السورس\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مالك السورس\n") 
...
redis:hset(ADHAM..'username:'..UserID, 'username',Resolv)
redis:sadd(ADHAM..'gban_users',UserID)
...
redis:srem(ADHAM..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif redis:sismember(ADHAM..':@Q_Y_4:',UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(ADHAM..':KARA_BOT:'..ChatID,UserID) then
Getrtb = 'منشئ اساسي' 
elseif redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(ADHAM..'owners:'..ChatID,UserID) then
...
if redis:sismember(ADHAM..':@Q_Y_4:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..':@Q_Y_4:',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_A" then
if not redis:sismember(ADHAM..':@Q_Y_4:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(ADHAM..':@Q_Y_4:',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد البابا ادهم\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد مالك السورس\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد مالك السورس\n") 
...
GetChatMember(ChatID,A_id,function(arg,data)
...
redis:hset(ADHAM..'username:'..UserID, 'username', UserName)
redis:sadd(ADHAM..':@Q_Y_4:'..ChatID,UserID)
...
if redis:sismember(ADHAM..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'♡ **العضو » ❪ '..UserName..' ❫\n♡ **الايدي » ❪ `'..UserID..'` ❫\n♡ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(ADHAM..':@Q_Y_4:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(ADHAM..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(ADHAM..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(ADHAM..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_A" then
if not redis:sismember(ADHAM..':@Q_Y_4:',UserID) then return sendMsg(ChatID,MsgID,'♡ **العضو » '..USERNAME..' \n♡ ** الايدي » (`'..UserID..'`)\n♡ **انه بالتأكيد ليس مطور \n') end
redis:srem(ADHAM..':@Q_Y_4:',UserID) 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(ADHAM..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(ADHAM..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(ADHAM..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(ADHAM..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*♡*` اعدادات المجموعه :` \n"
.."\n♡ التعديل «» "..(redis:get(ADHAM..'lock_edit'..msg.chat_id_) or 'false')
.."\n♡ الروابط «» "..(redis:get(ADHAM..'lock_link'..msg.chat_id_) or 'false')
.."\n♡ التاك «» "..(redis:get(ADHAM..'lock_tag'..msg.chat_id_) or 'false')
.."\n♡ المعرفات «» "..(redis:get(ADHAM..'lock_username'..msg.chat_id_) or 'false')
.."\n♡ التكرار «» "..(redis:get(ADHAM..'lock_flood'..msg.chat_id_) or 'false')
.."\n♡ الكلايش «» "..(redis:get(ADHAM..'lock_spam'..msg.chat_id_) or 'false')
.."\n♡ الويب «» "..(redis:get(ADHAM..'lock_webpage'..msg.chat_id_) or 'false')
.."\n♡ الماركدوان «» "..(redis:get(ADHAM..'lock_markdown'..msg.chat_id_) or 'false')
.."\n♡ بالطرد البوتات «» "..(redis:get(ADHAM..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n♡ البوتات «» "..(redis:get(ADHAM..'lock_bots'..msg.chat_id_) or 'false')
.."\n♡ عدد التكرار «» "..(redis:get(ADHAM..'num_msg_ADHAM'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡`اعدادات الوسائط :`\n"
.."\n*♡ *المتحركه «» "..(redis:get(ADHAM..'mute_gif'..msg.chat_id_) or 'false')
.."\n♡ الدردشه «» "..(redis:get(ADHAM..'mute_text'..msg.chat_id_) or 'false')
.."\n♡ الانلاين «» "..(redis:get(ADHAM..'mute_inline'..msg.chat_id_) or 'false')
.."\n♡ الالعاب «» "..(redis:get(ADHAM..'mute_game'..msg.chat_id_) or 'false')
.."\n♡ الصور «» "..(redis:get(ADHAM..'mute_photo'..msg.chat_id_) or 'false')
.."\n♡ الفيديو «» "..(redis:get(ADHAM..'mute_video'..msg.chat_id_) or 'false')
.."\n♡ البصمات «» "..(redis:get(ADHAM..'mute_audio'..msg.chat_id_) or 'false')
.."\n♡ الصوت «» "..(redis:get(ADHAM..'mute_voice'..msg.chat_id_) or 'false')
.."\n♡ الملصقات «» "..(redis:get(ADHAM..'mute_sticker'..msg.chat_id_) or 'false')
.."\n♡ الجهات «» "..(redis:get(ADHAM..'mute_contact'..msg.chat_id_) or 'false')
.."\n♡ التوجيه «» "..(redis:get(ADHAM..'mute_forward'..msg.chat_id_) or 'false')
.."\n♡ الموقع «» "..(redis:get(ADHAM..'mute_location'..msg.chat_id_) or 'false')
.."\n♡ الملفات «» "..(redis:get(ADHAM..'mute_document'..msg.chat_id_) or 'false')
.."\n♡ الاشعارات «» "..(redis:get(ADHAM..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n♡ الكيبورد «» "..(redis:get(ADHAM..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*`اعدادات اخرى : `"
.."\n\n*♡*الترحيب «» "..welcomex
.."\n*♡*الردود «» "..replayx
...
.."\n*♡*الويب «» "..(redis:get(ADHAM..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*♡*الماركدوان «» "..(redis:get(ADHAM..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*♡*البوتات بالطرد «» "..(redis:get(ADHAM..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*♡*البوتات «» "..(redis:get(ADHAM..'lock_bots'..msg.chat_id_) or 'false')
.."\n*♡*عدد التكرار «» "..(redis:get(ADHAM..'num_msg_ADHAM'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*اعدادات التقـييد :\n"
.."\n*♡*التقييد بالتوجيه «» "..(redis:get(ADHAM..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالصور «» "..(redis:get(ADHAM..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالروابط «» "..(redis:get(ADHAM..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالمتحركه «» "..(redis:get(ADHAM..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد الفيديو «» "..(redis:get(ADHAM..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
